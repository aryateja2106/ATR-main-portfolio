import { createRequire as topLevelCreateRequire } from 'node:module';const require = topLevelCreateRequire(import.meta.url);import bannerUrl from 'node:url';const __dirname = bannerUrl.fileURLToPath(new URL('.', import.meta.url));
...
// ../../node_modules/.bun/@opennextjs+cloudflare@1.16.2+73e503e3033d6e27/node_modules/@opennextjs/cloudflare/dist/api/overrides/asset-resolver/index.js
const resolver = {
...
const asset_resolver_default = resolver;

// ../../node_modules/.bun/@opennextjs+cloudflare@1.16.2+73e503e3033d6e27/node_modules/@opennextjs/cloudflare/dist/api/config.js
...
// open-next.config.ts
const open_next_config_default = defineCloudflareConfig({});
export {
