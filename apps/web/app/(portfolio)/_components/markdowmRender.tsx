        ...
        components={{
          code(props) {
            ...
            return !inline && match ? (
              ...
              <code
                className={`${className} rounded bg-neutral-100 dark:bg-neutral-800 px-1 py-0.5`}
                {...rest}
              >
                {children}
              </code>
          ...
          blockquote({ children }) {
            return (
              <blockquote className="border-l-4 border-neutral-300 dark:border-neutral-700 pl-4 italic my-4">
                {children}
              </blockquote>
            );
          },
