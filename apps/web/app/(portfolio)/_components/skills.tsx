...
const slugCategories: Record<string, TechItem[]> = {
  ...
  Frameworks: [
    ...
    { name: 'Swift', color: null, background: null },
    ...
    { name: 'Langchain', color: null, background: null },
    { name: 'CrewAI', color: null, background: null },
    {
      name: 'shadcn/ui',
      color: null,
      background: 'bg-white',
      iconUrl: 'https://ui.shadcn.com/apple-touch-icon.png',
    },
  ],
  'Tools & Infrastructure': [
    ...
    { name: 'v0', color: null, background: null },
    { name: 'Claude', color: null, background: null },
    { name: 'OpenAI', color: null, background: null },
    {
      name: 'Cursor',
      color: null,
      background: 'bg-white',
  ...
  'Design & Collaboration': [
    ...
    { name: 'Notion', color: null, background: null },
    { name: 'Obsidian', color: null, background: null },
    { name: 'Cursor', color: null, background: null }, // Add cursor color
    { name: 'GitHub', color: null, background: null },
    { name: 'GitLab', color: null, background: null },
    { name: 'Figma', color: null, background: null },
    { name: 'Canva', color: null, background: null },
    { name: 'Miro', color: null, background: null },
  ],
};
