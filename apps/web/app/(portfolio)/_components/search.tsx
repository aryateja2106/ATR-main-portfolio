  ...
  return (
    <>
      ...
      >
        ...
        <kbd className="bg-neutral-100 p-1 dark:bg-neutral-950 rounded-lg border border-neutral-300 dark:border-neutral-700 text-neutral-600 dark:text-neutral-500 leading-none hidden md:flex">
          Ctrl K
        </kbd>
      </button>
