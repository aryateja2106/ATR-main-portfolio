...
const AccordionTrigger: FC<AccordionTriggerProps> = ({ children, className = '', onClick, isOpen }) => (
    <button type="button" className={`flex w-full items-center justify-between py-3 text-sm font-medium transition-all hover:text-neutral-100 text-neutral-400 ${className}`} onClick={onClick}>
      {children}
      <motion.svg 
