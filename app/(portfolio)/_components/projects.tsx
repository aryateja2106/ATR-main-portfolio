...
const projectsData: Project[] = [
  {
    ...
    description:
      'Datacenter Scale Distributed Inference Serving Framework. Forked to understand datacenter-scale inference, distributed systems, and multi-GPU topologies for LeSearch AI.',
  ...
  },
  {
    ...
    description:
      'Privacy-focused natural language to SQL tool connecting to local Postgres databases using local LLMs. Includes safety guardrails and schema introspection.',
  ...
  },
  {
    ...
    statusVariant: 'active', // Teal
    description:
      'AI research agent assisting users throughout their research paper reading journey. Features RAG for comprehension and discovery.',
    techStack: ['Next.js', 'Supabase', 'FastAPI', 'RAG', 'VectorDB'],
    githubLink: 'https://github.com/TechForAqua/lesearch-app',
