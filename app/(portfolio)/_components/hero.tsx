...
export function Hero() {
  ...
  return (
    ...
    <div className="relative flex min-h-[85vh] w-full flex-col items-center md:justify-center py-8 px-4 md:px-0">
      {/* Background effects */}
      <div className="absolute -z-50 size-64 top-20 left-0 bg-[conic-gradient(transparent,rgb(0,0,0))] opacity-15 blur-2xl dark:bg-[conic-gradient(transparent,rgb(255,255,255))] md:left-36" />
      ...
      >
        ...
        <motion.div 
          className="hover:scale-105 transition-all duration-300 -translate-y-1/6 z-20 hidden md:block"
          variants={itemVariants}
          initial="hidden"
          animate="visible"
          whileHover={{ 
      ...
      >
        <div className="relative">
          <Image
            ...
            priority
          />
          <div className="absolute -z-50 size-64 bottom-20 right-0 bg-[conic-gradient(transparent,rgb(0,0,0))] opacity-15 blur-2xl dark:bg-[conic-gradient(transparent,rgb(255,255,255))]" />
