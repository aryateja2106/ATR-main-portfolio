...
import { getAllBlogs, getAllCategories, getBlogsByCategory, sortBlogsByDate} from '../_hooks/blog'
              ...
              >
                ...
                <div className="p-5 grow flex flex-col">
                  ...
                  <div className="mt-auto flex items-center text-teal-500 text-sm font-medium">
                    Read article
                    <svg className="ml-1 size-4 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
